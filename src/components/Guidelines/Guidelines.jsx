          ...
          <div classNae="space-y-4">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-3">
                ...
                <span><strong>Deadline:</strong> 7th April 2025</span>
              </li>
              <li className="flex items-center gap-3">
                <ArrowRight className="text-purple-500 w-5 h-5 flex-shrink-0" />
              ...
              <li className="flex items-center gap-3 mt-3">
                <ArrowRight className="text-purple-500 w-5 h-5 flex-shrink-0" />
                <strong>Shortlisted Teams Announcement:</strong> 11th April 2025
              </li>
              <li className="flex items-center gap-3 mt-3">
                <ArrowRight className="text-purple-500 w-5 h-5 flex-shrink-0" />
        ...
        <div className="bg-gray-800 p-8 rounded-lg space-y-6 mt-8">
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-3">
                <ArrowRight className="text-purple-500 w-5 h-5 flex-shrink-0" />
                <span><strong>Deadline:</strong> 17th April 2025</span>
              </li>
              <li className="flex items-center gap-3">
                <ArrowRight className="text-purple-500 w-5 h-5 flex-shrink-0" />
