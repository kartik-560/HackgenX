            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`mt-2 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-[#25d8de] focus:ring-[#25d8de] px-4 py-3 ${
              ...
              <div>
                ...
                >
                  ...
                  <option value="Smart Warehouse Space Optimization">
                    Smart Space Optimization– AI-driven storage and inventory tracking" 
                  </option>
                  <option value="Automated Asset Lifecycle Management">
                  Smart Building Energy Optimization – AI-powered energy efficiency and control
                  </option>
                  <option value="Smart Budget Allocation System">
                  Automated Spill & Garbage Detection – AI-powered waste management
                  </option>
                  <option value="Intelligent Ore Quality Prediction">
                  Deforestation & Wildlife Tracking using AI – Remote sensing and conservation monitoring
                  </option>
                  <option value="Smart Building Energy Optimization">
                  Smart Pollution Control & Monitoring – AI + IoT for real-time air & water quality tracking"
                  </option>
                  <option value="Deforestation & Wildlife Tracking using AI">
                  Smart & Sustainable E-Waste Management – Scalable solutions for responsible e-waste disposal"
                  </option>
                  <option value="Automated Spill & Garbage Detection">
                  Automated Asset Lifecycle Management – AI-powered asset tracking and predictive maintenance
                  </option>
                  <option value="Automated Spill & Garbage Detection">
                  Smart Budget Allocation System – Automated public budget allocation using data
                  </option>
                  <option value="Automated Spill & Garbage Detection">
                  Enhancing Design Software with AI-Driven Interfaces  
                  </option>
                </select>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className={`mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-200 shadow-sm focus:border-[#25d8de] focus:ring-[#25d8de] py-2 px-4 ${
                    errors.whyParticipate ? "border-red-500" : ""
                  }`}
