...
export default function Hero() {
  ...
  const registrationEndDate = "April 5, 2025";
  ...
  return (
    <section className="pt-8 pb-20 px-6 mt-20">
      <div className="max-w-7xl mx-auto text-center">
        {/* <div>  </div> */}
        <div className="text-purple-500 text-4xl font-semibold  flex items-center justify-center gap-5 hero-logo-text">
          {/* <img
            src={sipnaLogo}
            alt="Sipna logo"
            height="90px"
        ...
        <p className="text-white text-2xl text-center mt-[10px] xs:mt-4 sm:mt-[-15px]">
          In association with
        </p>
        ...
        <div
          ...
          style={{ margin: "25px" }}
        >
          GRAND FINALE on 16<sup>th</sup> & 17<sup>th</sup> April
        </div>
        <div
