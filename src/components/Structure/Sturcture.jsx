        ...
        <div className="space-y-8">
          <div className="bg-gray-700 p-8 rounded-lg">
            <h3 className="text-2xl font-semibold text-white mb-4">
              Round 1: Screening Round (Online)
            </h3>
            ...
            <p className="text-gray-300">
              <b className="text-white"> 🕒 Duration:</b> 5 - 7 April 2025
            </p>
          ...
          {/* <div className="bg-gray-700 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              <b className="text-white">📌 Objective:</b> Showcase the final project to the judges.
            </p>
            <p className="text-gray-300">
              <b className="text-white"> 🕒 Duration:</b> 6 hours
            </p>
            ...
            <div className="text-gray-300 space-y-2">
              <div className="flex items-start gap-2">
                <span className="text-purple-500">•</span>
                <p>Teams will prepare a structured pitch to present their project.</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-purple-500">•</span>
                <p>
                The presentation should highlight problem-solving, innovation, technical execution, and scalability.
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-purple-500">•</span>
                <p>	Live demos are encouraged to demonstrate functionality.</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-purple-500">•</span>
                <p>
                Judges will evaluate based on impact, implementation, and originality before selecting winners.
                </p>
              </div>
            </div>
          </div> */}
